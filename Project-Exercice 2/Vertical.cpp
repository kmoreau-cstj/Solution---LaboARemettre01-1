// But: Écrire un programme qui vérifie que le nombre entré contient bien 5 chiffres et les affiches verticalement par la suite
// Nom: Maxym Blondin
// Date: 2020-09-14
...
void main()
{
		...
		//Ouverture d'un bloc d'instruction qui sera executé seulement si la condition est vraie
	{
		...
		//Essai 1 pour mettres les nombres sur une ligne différente: \n (false)
